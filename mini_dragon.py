...
class Mini_dragon:
    def __init__(self, screen, health, move_distance, speed, x, y, direction):
        self._mini_dragon_img = pygame.image.load("images/mini_dragon.png")
        self._screen = screen
        self._x = x
        self._y = y
        self._x_change = speed * direction
        self._move_distance = move_distance
        self._speed = speed
        self._health = health

    @property
    def mini_dragon_img(self):
        return self._mini_dragon_img
    ...
    def display(self):
        self._screen.blit(self.mini_dragon_img, (self.x, self.y))
