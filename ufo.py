...
def random_speed(speed):
    return random.uniform(0, 1) * 0.08 + speed


class Purple1:
    def __init__(self, init_dict):
        __new_random_speed = random_speed(init_dict["speed"])
        self._img = pygame.image.load("images/enemy.png")
...
class Ufo1:
    def __init__(self, init_dict):
        __new_random_speed = random_speed(init_dict["speed"])
        self._img = pygame.image.load("images/ufo1.png")
        self._screen = init_dict["screen"]
        self._x = random.randint(borderLeft + 1, borderRight - enemy_size - 1)
        self._y = random.randint(height//20, height//4)
        self._x_change = __new_random_speed * random.choice([-1, 1])
...
class Ufo2:
    def __init__(self, init_dict):
        __new_random_speed = random_speed(init_dict["speed"])
        self._img = pygame.image.load("images/ufo2.png")
        self._screen = init_dict["screen"]
        self._x = random.randint(borderLeft + 1, borderRight - enemy_size - 1)
        self._y = random.randint(height//20, height//4)
        self._x_change = __new_random_speed * random.choice([-1, 1])
...
class Ufo3:
    def __init__(self, init_dict):
        __new_random_speed = random_speed(init_dict["speed"])
        self._img = pygame.image.load("images/ufo3.png")
        self._screen = init_dict["screen"]
        self._x = random.randint(borderLeft + 1, borderRight - enemy_size - 1)
        self._y = random.randint(height//20, height//4)
        self._x_change = __new_random_speed * random.choice([-1, 1])
